  ...
  return (
    <div className="bg-card">
      <div className="container mx-auto max-w-4xl py-16 px-6">
        ...
        {/* Privacy Summary */}
        <div className="mb-12 p-6 bg-success/10 rounded-lg border border-success/20">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="p-4 bg-tool-primary/10 rounded-lg border border-tool-primary/20">
              <h3 className="text-lg font-medium text-foreground mb-2">
