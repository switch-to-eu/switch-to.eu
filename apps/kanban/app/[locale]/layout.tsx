                  ...
                  <Link href="/">
                    <div className="flex items-start gap-2 transition-opacity hover:opacity-80">
                      <div className="flex items-center justify-center mt-1">
                        <KanbanSquare className="h-4 w-4 text-primary-color" />
                      </div>
                      <div className="flex flex-col">
                        <span className="text-lg font-black text-primary-color tracking-wide uppercase sm:text-xl leading-none">Kanban</span>
              ...
              <Footer
                    ...
                    &copy; {footerT.rich('copyright', {
                      ...
                      link: (chunks) => (
                        <a
                          ...
                          className="text-indigo-600 hover:text-indigo-500 transition-colors font-semibold underline"
                        >
                          {chunks}
                        </a>
                      ),
                ...
                branding={
                  <div className="flex flex-col gap-1">
                    <span className="text-lg font-black tracking-wide uppercase text-foreground">Kanban</span>
