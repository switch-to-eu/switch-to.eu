    ...
    <main>
      ...
      <section className="relative overflow-hidden header-bg">
        <div className="container mx-auto px-4 py-20 text-center">
          ...
          <p className="text-lg text-neutral-500 max-w-2xl mx-auto mt-4 mb-8">
            {t("hero.description")}
          </p>
          <Link href="/create">
      ...
      <section className="border-y bg-white">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center text-sm text-neutral-600">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-neutral-500 mt-2">{t("benefits.description")}</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="rounded-xl border bg-white p-6">
              ...
              <p className="text-neutral-500">{t("benefits.privacy.description")}</p>
            </div>
            <div className="rounded-xl border bg-white p-6">
              <Eye className="h-8 w-8 text-indigo-600 mb-4" />
              <h3 className="text-xl font-semibold mb-2">{t("benefits.encrypted.title")}</h3>
              <p className="text-neutral-500">{t("benefits.encrypted.description")}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white border-t">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-neutral-500 mb-8">{t("cta.description")}</p>
          <Link href="/create">
            <Button size="lg" className="gradient-primary text-white font-semibold px-8">
              {t("cta.button")}
            </Button>
