 ...
 * Get all services
 */
export async function getAllServices(lang: Locale = 'en'): Promise<Array<ServiceFrontmatter>> {
 ...
 */
export async function getEUServices(lang: Locale = 'en'): Promise<Array<ServiceFrontmatter>> {
 ...
 */
export async function getNonEUServices(lang: Locale = 'en'): Promise<Array<ServiceFrontmatter>> {
    const services = await getAllServices(lang);
