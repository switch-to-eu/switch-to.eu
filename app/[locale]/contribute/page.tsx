...
export default async function ContributePage({
  ...
  return (
    <div className="flex flex-col gap-8 sm:gap-12 py-6 md:gap-20 md:py-12">
      ...
      <section>
        <Container>
          <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-center">{t('helpSection.title')}</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">{t('cards.migration.title')}</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">{t('cards.tester.title')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-center">
                  {t('cards.tester.description')}
                </p>
              </CardContent>
              <CardFooter className="justify-center">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">{t('cards.discover.title')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-center">
                  {t('cards.discover.description')}
                </p>
              </CardContent>
              <CardFooter className="justify-center">
                <Link href="https://github.com/switch-to-eu/content/issues/new" target="_blank" className="text-blue hover:underline">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">{t('cards.technical.title')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-center">
            ...
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">{t('cards.ideas.title')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-center">
                  {t('cards.ideas.description')}
                </p>
              </CardContent>
              <CardFooter className="justify-center">
                <Link href={`/${locale}/feedback`} className="text-blue hover:underline">
                  {t('cards.ideas.cta')} →
                </Link>
              </CardFooter>
            </Card>
      ...
      <section>
        <Container>
          <div className="bg-[#e8fff5] p-6 sm:p-10 rounded-xl text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">{t('whyMatters.title')}</h2>
