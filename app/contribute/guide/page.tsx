        ...
        <Container>
          <div className="flex flex-col md:flex-row items-start gap-8">
            <div className="flex-1">
              <h1 className="text-3xl sm:text-4xl font-bold mb-6 ">Contributing to Switch-to.EU Content</h1>
      ...
      <section>
        <Container>
          <div className="prose prose-slate max-w-none lg:prose-lg dark:prose-invert">
            <h2 className="text-2xl font-bold mt-8 ">Repository Overview</h2>
            <p className="">
            ...
            <h2 className="text-2xl font-bold mt-8 ">What You Can Contribute</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 ">Contribution Process</h2>
            ...
            <h3 className="text-xl font-bold mt-6 ">2. Clone Your Fork (Optional)</h3>
            <p className="">If you prefer to work locally:</p>
            ...
            <h3 className="text-xl font-bold mt-6 ">3. Create or Edit Content</h3>
            <p className=""><strong>Option A: Edit Directly on GitHub</strong></p>
            <ul className="space-y-1 ">
            ...
            <p className=" mt-4"><strong>Option B: Edit Locally</strong></p>
            <ul className="space-y-1 ">
            ...
            <h3 className="text-xl font-bold mt-6 ">4. Follow Content Structure</h3>
            <p className="">Our content is organized as follows:</p>
            <ul className="space-y-1 ">
            ...
            <h3 className="text-xl font-bold mt-6 ">5. Submit a Pull Request</h3>
            <ul className="space-y-1 ">
            ...
            <h2 className="text-2xl font-bold mt-8 ">Content Guidelines</h2>

            <h3 className="text-xl font-bold mt-6 ">Formatting</h3>
            <ul className="space-y-1 ">
            ...
            <h3 className="text-xl font-bold mt-6 ">Writing Style</h3>
            <ul className="space-y-1 ">
            ...
            <h3 className="text-xl font-bold mt-6 ">Migration Guides Structure</h3>
            <p className="">Each migration guide should include:</p>
            <ul className="space-y-1 ">
            ...
            <h2 className="text-2xl font-bold mt-8 ">Review Process</h2>
            <p className="">After submitting your pull request:</p>
            <ul className="space-y-1 ">
            ...
            <h2 className="text-2xl font-bold mt-8 ">Questions and Support</h2>
            <ul className="space-y-1 ">
